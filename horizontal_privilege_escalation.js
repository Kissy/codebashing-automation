var MAPPING = {
    'Which of the options best describes a Horizontal Privilege Escalation attack?': '2. An attacker is able to obtain similar privileges in an environment to the ones they currently have, but in a scope or domain that belongs to other users'
};
