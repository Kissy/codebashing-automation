var MAPPING = {
    'How to prevent or reduce the impact of Reflected XSS?': '4. All of the above'
};
    ...
    if (!activeMenu) {
        ...
        switch (activeMenu.textContent) {
            case "1":
                ...
                break;
            case "2":
                var react = findReact(document.querySelector('input.-search-bar-'), 3);
                if (react) {
                    react.setState({search: "test"});
                    react.onSearchClicked();
                }
                break;
            case "3":
                clickIfAvailable('button.-action-back-button-');
                clickIfAvailable('button.next-button');
                break;
            case "4":
                ...
                break;
            case "5":
                clickIfAvailable('button.-action-back-');
                break;
            case "6":
                break;
            case "7":
