var MAPPING = {
    'What is the right strategy to prevent session fixation vulnerability?': '2. Issue a new session ID after a user authenticates',
};
    ...
    if (!activeMenu) {
        ...
        switch (activeMenu.textContent) {
            ...
            case "3":
                ...
                break;
            case "4":
                // TODO clickIfAvailable('a.-action-Login-');
                clickIfAvailable('button.next-button');
                break;
            case "5":
                clickIfAvailable('button.next-button');
