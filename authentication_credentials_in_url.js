var MAPPING = {
    'The authentication credentials are stored in the URL(e.g. http://codebashing.com/login?username=admin&password=admin). Where can they be leaked from?': '4. All of the above'
};
